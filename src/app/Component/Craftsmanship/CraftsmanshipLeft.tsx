...
const CraftsmanshipLeft = ({ image, changeOrder }: any) => {
  return (
    <section className="post h-[70vh] grid grid-cols-1 md:grid-cols-5 ">
      <div className={`md:col-span-3 h-full ${changeOrder ? "order-2" : ""}`}>
        <img
      ...
      <div className="flex-1 p-12 flex flex-col justify-center gap-8 md:col-span-2 text-center md:text-left">
