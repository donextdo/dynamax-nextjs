            ...
            <div className='container mx-auto'>
                {/* <div className='grid gap-[1.5rem] lg:gap-0 grid-cols-1 md:grid-cols-2 lg:grid-cols-4 py-6 border-b-2 border-gray-600 '>
                    <div className='md:col-span-2 flex flex-col items-start gap-6 w-full px-[15px]'>
                        <div className="text-[30px] text-[#97BF04] font-semibold leading-[45px]">
                            <a href="/">
                                <h2>DYNAMAX</h2>
                            </a>
                        </div>
                    ...
                    <div className='w-full px-[15px]'>
                        ...
                        <ul className="flex flex-col items-start gap-4">
                            <li className="text-base font-medium capitalize relative">
                                <a href="#hot-deals" className='hover:text-[#97BF04]'>hot deals</a>
                            </li>
                            <li className="text-base font-medium capitalize relative">
                                <a href="#our-range" className='hover:text-[#97BF04]'>our range</a>
                            </li>
                            <li className="text-base font-medium capitalize relative">
                                <a href="#warrenty" className='hover:text-[#97BF04]'>service</a>
                            </li>
                            <li className="text-base font-medium capitalize relative">
                                <a href="#contact-us" className='hover:text-[#97BF04]'>contact us</a>
                            </li>
                        </ul>
                    </div>
                ...
                <div className='flex items-center justify-center py-6 border-b-2 border-gray-600'>
                    <div className='flex gap-2 sm:grid sm:gap-[1.5rem] sm:gap-0 grid-cols-2 '>
                        <div className='w-full px-[15px]'>
                ...
                <div className='text-center mt-4'>
                    <p className="text-[13px] text-[#676267] tracking-wide">Copyright &copy; 2023 Dynamx. All Rights Reserved.</p>
