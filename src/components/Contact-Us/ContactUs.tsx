    ...
    return (
        <div id="contact-us" className='container mx-auto px-[16px] py-[60px] grid grid-cols-1  md:grid-cols-5 gap-4 scroll-mt-14'>
            <div className='col-span-2'>
                ...
                <h5 className="font-semibold text-black mt-4 mb-3 text-[19.2px]">Head Office</h5>
            ...
            <div className='col-span-3 bg-[#e5e7eb] py-[32px] px-[48px] w-full'>
                ...
                <form>
                    <div className="mb-4 flex flex-col gap-2">
                        <label className="text-base text-black font-medium">Enquiring About</label>
                        <input type="text" className="bg-transparent border-2 border-gray-600 font-medium focus:border-gray-600 focus:outline-none focus:shadow-none rounded py-[8px] px-[16px]" placeholder="Mention your message purpose" />
                    </div>

                    <div className="mb-4 flex flex-col gap-2">
                        <label className="text-base text-black font-medium">Your Region</label>
                        <select className="bg-transparent border-2 border-gray-600 font-medium focus:border-gray-600 focus:outline-none focus:shadow-none rounded py-[8px] px-[16px]" placeholder="Mention your message purpose">
                    ...
                    <div className="mb-4 grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div className="flex flex-col gap-2">
                            <label className="text-base text-black font-medium">First Name</label>
                        ...
                        <div className="flex flex-col gap-2">
                            <label className="text-base text-black  font-medium">Last Name</label>
                    ...
                    <div className="mb-4 grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div className="flex flex-col gap-2">
                            ...
                            <input type="text" className="bg-transparent border-2 border-gray-600 font-medium focus:border-gray-600 focus:outline-none focus:shadow-none rounded py-[8px] px-[16px]" placeholder="Your phone number" />
                        </div>

                        <div className="flex flex-col gap-2">
                            <label className="text-base text-black  font-medium">Email</label>
                            <input type="email" className="bg-transparent border-2 border-gray-600 font-medium focus:border-gray-600 focus:outline-none focus:shadow-none rounded py-[8px] px-[16px]" placeholder="Your email address" />
                        </div>
                    </div>

                    <div className="mb-10 flex flex-col gap-2">
                        <label className="text-base text-black  font-medium">Comments</label>
